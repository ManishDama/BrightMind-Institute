...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %> <%-- Added for consistency, though not strictly used for dates in this specific table --%>
...
<head>
    ...
    <title>Students for Announcement</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10 col-xl-8">
                <div class="card shadow-lg rounded-4 p-4 p-md-5">
                    <h2 class="text-center text-dark mb-4 pb-3 border-bottom">Students for Announcement</h2>
                    ...
                    <c:if test="${empty listOfStudents}">
                        <div class="alert alert-info text-center py-3 rounded-3" role="alert">
                            <p class="mb-0">No students found for this announcement.</p>
                        </div>
                    </c:if>
